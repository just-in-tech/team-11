...
export class SoundFileAsset {
    ...
    play() {
        ...
        if (this.#sources.length >= this.#max) {
            console.warn(
                `You've tried to spawn too many copies of ${this.soundFileName}, sounds have a maximum number of instances they can have playing at any one time if you want to play more copies at once change the .maxCopies for this sound`
            );
            return;
        }
