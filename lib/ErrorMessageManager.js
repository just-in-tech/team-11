...
export class ErrorMsgManager {
     ...
     * @returns {string} A string containing the error messages of the objects (if any).
     */
    ...
    static loadFileFailed(filepath, type, msg = "") {
        ...
        switch (type) {
            ...
            case `font`:
                ...
                const filepathEnding = filepath.split(".").pop();
        ...
        const numberOfSlashes = filepath.matchAll("/");
