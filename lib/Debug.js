...
export class Debug {
    ...
    static constructGroupPane() {
        ...
        for (let group of Group.all) {
            html += `<li>${group.name || ""} Group(${group.length}):${
                group.type
            }</li>`;
        }
        html += "</ul>";
     ...
     * @param {Pen} pen - The pen object to draw with.
     * @param {Keys} keys - The keys object to draw debug information for.
     ...
     * @param {Pen} pen - The pen object to draw with.
     * @param {Image} img - The image object to draw debug information for.
     * @static
     */
