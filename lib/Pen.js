...
import { Animation, MovingStamp } from "./Animation.js";
...
export class Pen {
    ...
    constructor(
        ...
        if (!this.debug_aside) {
            ...
            document.querySelector("body").appendChild(nuDebugAside);
...
${Video.loading.title} | ${Video.loading.url}
    ...
    loadMovingStamp(x, y, ...filepaths) {
        throw Error("this should be removed, use load animation instead");
    }
